...
public class TextEditor {
     ...
     */
    public Collection<com.funnyboyroks.markdown.HTMLToken> tokenizeHTML() {
        List<com.funnyboyroks.markdown.HTMLToken> tokens = new ArrayList<com.funnyboyroks.markdown.HTMLToken>();
        ...
        while (m.find()) {
            if (lastPos < m.start()) {
                tokens.add(com.funnyboyroks.markdown.HTMLToken.text(text.substring(lastPos, m.start())));
            }
            tokens.add(com.funnyboyroks.markdown.HTMLToken.tag(text.substring(m.start(), m.end())));
            lastPos = m.end();
        }
